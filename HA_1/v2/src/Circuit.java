...
public class Circuit {
    ...
    public static void main(String[] args) {
        ...
        switch (module){
            ...
            case "Kurzschluesse":
                ...
                break;
            default:
                System.out.print("Fehlerhafte Eingabe, Bitte waehlen Sie zwischen 'Widerstaende',");
                System.out.println(" 'Kondensatoren' oder 'Kurzschluesse': ");
        }
    ...
    public static void res() {
        ...
        double R_ges_zwischenwert = 1 / resistor1 + 1 / resistor2;
        double totalResistance = Math.round(1 / R_ges_zwischenwert);
